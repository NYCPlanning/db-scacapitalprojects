...
(SELECT a.district, a.school, a.projectnum, 'capacity projects'::text AS description, b.location, b.latitude, b.longitude, a.totalestcost, substring(a.actualestcompl, 1, strpos (a.actualestcompl,'-')-1) actualestcompl_month,
