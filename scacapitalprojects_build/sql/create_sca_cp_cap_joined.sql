...
(SELECT a.existingsiteidentified, a.proposedleasedfacility,a.district, a.school, a.projectnum, 'capacity projects'::text AS description, b.location, b.latitude, b.longitude, a.actualestcompl, a.designstart, a.constrstart, a.totalestcost, substring(a.actualestcompl, 1, strpos (a.actualestcompl,'-')-1) actualestcompl_month,
